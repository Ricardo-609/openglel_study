...
Java_com_ricardo_openglel_1study_EGLDemoActivity_createGLRender(JNIEnv *env, jobject thiz,
                                                             jobject surface) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_EGLDemoActivity_showBitmap(JNIEnv *env, jobject thiz, jint render,
                                                         jobject bitmap) {
    AndroidBitmapInfo info; // create a AndroidBitmapInfo
    int result;
    // 获取图片信息
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_EGLDemoActivity_releaseGLRender(JNIEnv *env, jobject thiz,
                                                              jint render) {
    GLRender *pGLRender = reinterpret_cast<GLRender *>(render);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_EGLDemoActivity_switchToFilterNative(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ricardo_openglel_1study_EGLDemoActivity_adjust(JNIEnv *env, jobject thiz, jint render,
